...
EXPECTED_RESULTS = {
  ...
  5: {
    'splash': u'HELL STORM SLAMS COAST; WINDS TOP 145 MPH',
    'top': []
  },
  6: {
    'splash': None,
    'top': [
      u"FLASHBACK:  Judge in charge of Saddam Hussein's trial was in fear for his life today after his identity was revealed by a UK newspaper..."
    ]
  },
  7: {
    'splash': u'Relief Head Questions New Orleans Reopen',
    'top': [
      u'Adios, Posse Comitatus:  Military May Play Bigger Relief Role...',
      u'Money Earmarked for Evacuation Was Redirected...',
      u'Dem Brazile:  I Will Rebuild With You, Mr. President...'
    ]
  },
  8: {
    'splash': u'Bird flu confirmed:  Dead swan in the UK',
    'top': [
      u"Clinton Deja Vu: Hillary Caught Stealing Bill's Old Lines... ",
  ...
  9: {
    'splash': None,
    'top': [
      u'DRUDGE RADIO LIVE SUNDAY NIGHT 10 PM ET TO 1 AM... HEARD IN ALL 50 STATES...'
    ]
  },
  10: {
    'splash': u'STALEMATE',
    'top': [
      u'BIGGEST GOVERNMENT   EVER!  Fed revenue collections and spending  at all-time highs... MORE...'
    ]
  },
  11: {
    'splash': u'TROUBLE IN THE CITI',
    'top': [
      u"CAN SHE BEAT THEM?  New poll shows Clinton trails top '08 Republicans..."
    ]
  },
  12: {
    'splash': u'RUSSERT DEAD AT NBC',
    'top': [
      u'Tributes pour in...',
  ...
  13: {
    'splash': u'BLAGO STRIKES BACK!',
    'top': [
      u'On collision course with Washington...',
      u'CHICAGOLAND:  Indicted Governor Names Obama Replacement...'
    ]
  },
  14: {
    'splash': u'THE WAY IT USED TO BE',
    'top': [
      u'Taliban video shows captive US soldier...'
    ]
  },
  15: {
    'splash': u'SEAT ME',
    'top': [
        u'COURIC FACES PAY CUT; DEEP LAYOFFS HIT CBSNEWS...',
        u'NY POST:  COURIC, CBS REACH CROSSROADS...',
        u"'This is where I am for now'..."
      ]
    },
  16: {
    'splash': u'PENTAGON EYES WIKILEAKS CHARGES',
    'top': [
      u'Iran unveils long-range bombing drone...',
      u'US delays missile-zapping laser test for 4th time...'
    ]
  },
  17: {
    'splash': u'SAUDI POLICE OPEN FIRE ON PROTESTERS',
    'top': [
      u'SARKOZY, CAMERON TAKE CHARGE ON LIBYA...',
      u'HILLARY: U.S. should wait for world to act...',
      u'Top U.S. Spy: GADHAFI WILL PREVAIL...'
    ]
  },
  18: {
    'splash': u'OBAMACARE HEADED FOR SUPREMES',
    'top': [
      u'$200K Per Job? Geithner Says White House  Plan Still Bargain...'
    ]
  },
  19: {
    'splash': u'ROMNEY WARNS:  OBAMA COMING FOR GUNS',
    'top': [
      u'WHAT HAPPENS IN VEGAS, STAYS IN VEGAS:  GSA OFFICIAL TO THE FIFTH...'
    ]
  },
  20: {
    'splash': u'THE MORNING AFTER', 
    'top': []
  },
  21: {
    'splash': u"TAXES IN FRANCE 'TOP 100% OF INCOME'",
    'top': []
  },
  22: {
    'splash': u'MEX NUKE MYSTERY',
    'top': [
      u'BLAST:  -40\xb0 MIDWEST!',
      u'Deep freeze across western half of nation...',
      u'Chill Temps Live...'
    ]
  },
  23: {
    'splash': u'BOOK: HILLARY HAS BAD HEART',
    'top': []
  },
  24: {
    'splash': u'EURABIA DEBATE ERUPTS',
    'top': [
      u'Suspects spotted, manhunt continues...',
      u'Kouachi Rap Video... ',
